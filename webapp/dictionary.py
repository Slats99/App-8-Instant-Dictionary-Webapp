...
class Dictionary:
    ...
    def serve(cls, req):
        ...
        # Create div for the whole page
        div = jp.Div(a=wp, classes="bg-gray-200 h-screen p-24")
        # create a container for the dictionary function
        con = jp.Div(a=div, classes="bg-purple-300 p-10 rounded")
        # two lines of titles
